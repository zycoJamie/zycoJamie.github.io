import{_ as n,o as t,e as a,i as r,s as i,v as o,E as s,H as u}from"./chunks/framework.CXoXy2UI.js";const w=JSON.parse('{"title":"vue2源码阅读2--响应式原理","description":"","frontmatter":{"title":"vue2源码阅读2--响应式原理","class":"vue","date":"2021-11-09"},"headers":[],"relativePath":"posts/2021-vue-vue2源码阅读2响应式原理.md","filePath":"posts/2021-vue-vue2源码阅读2响应式原理.md"}'),d={name:"posts/2021-vue-vue2源码阅读2响应式原理.md"};function c(l,e,p,h,m,v){return t(),a("div",null,[e[1]||(e[1]=r("pre",{class:"mermaid-container",style:{visibility:"hidden"}},`graph TD
...
updated --> End[完成响应式更新]
`,-1)),(t(),i(s("script"),null,{default:o(()=>e[0]||(e[0]=[u(' (() => { const timer = setInterval(async () => { if (window.mermaid) { await window.mermaid.run({ querySelector: ".mermaid-container" }); const container = document.querySelector(".mermaid-container"); if (container) { container.style.visibility = "visible"; } clearInterval(timer); } }, 500); })(); ')])),_:1}))])}const b=n(d,[["render",c]]);export{w as __pageData,b as default};
